...
TABLA = table([], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [],[],[],[],[],[],[],[],[],[],[], [], [],[],...
    ...
    'Curvas', 'Consumo', 'consumoPorKilometro'});
        ...
        try
            ...
            for k = 1:numel(datosBuses.(bus).(fecha).tiempoRuta(:, 1))
                ...
                nuevaFila = table(string(bus), string(fecha), k, id, string(sexo), hora_inicio, hora_final, acelepercent1, acelepercent2, frepercent1,frepercent2, ...
                    ...
                    rutadato.tiempoRuta.Kilometros_Ida(k), rutadato.tiempoRuta.Ruta(k), distancia, tiempo, velocidad, Fre_km, Acc_km, curvas, consumo_recorrido, consumo_recorrido/rutadato.tiempoRuta.Kilometros_Ida(k),...
                    ...
                    'KilometrosRuta', 'NombreRuta', 'Distancia', 'Tiempo', 'Velocidad','Fre_km','Acc_km','Curvas', 'Consumo', 'consumoPorKilometro'});
