...
%%
saasdas = Calculos.reorganizarDatosPorBus(tiemposRutas);
...
generarDatos('2024-04-16 3:31:23.434', '2024-04-16 4:34:00.434', '4104')
...
function generarDatos(fechaInicio, fechaFinal, IDbus)
