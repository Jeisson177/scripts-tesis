%Datos del telefono
datosSensor = ImportarDatos.Sensor();% Importar los datos del telefono
...
%%
myMapaV = Map.Velocidad(datosCordenadasSensor, '2024-02-15 10:30:00.434', '2024-02-15 11:20:00.434');
...
mygraficaAc = Graficas.aceleracionTiempo(datosCordenadasSensor, '2024-02-15 8:30:00.434', '2024-02-15 9:35:00.434', 'filtrar');
mygraficaAc = Graficas.aceleracionTiempo(datosCordenadasSensor, '2024-02-15 8:30:00.434', '2024-02-15 9:35:00.434', 'metodo1', mygraficaAc);

%mygraficaAs = Graficas.aceleracionTiempo(datosCordenadasP20   , '2024-02-15 8:30:00.434', '2024-02-15 9:35:00.434', 'metodo1', mygraficaAc);
